class UserDataModelClass {
  ...
  factory UserDataModelClass.fromJson(var parse) {
    return UserDataModelClass(
        userAttributes:
            List<UserDetailsModelClass>.from(parse["results"].map((item) {
...
class UserDetailsModelClass {
  ...
  UserDetailsModelClass(
      {this.nameModelClass, this.userPicsModelClass, this.userNameModelClass});
...
class UserName {
  ...
  factory UserName.fromJson(var parse) {
    return UserName(userName: parse["username"]);
  }
}
