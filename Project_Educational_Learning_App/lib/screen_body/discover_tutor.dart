...
class DiscoverTutorBody extends StatefulWidget {
   DiscoverTutorBody({Key? key}) : super(key: key);
...
TextEditingController _conSearch = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          TextFieldWidget(controller: _conSearch,color:Color(0xFFEBECF0),leadingIcon: Icons.search,hintText: "Search by Name",trailingIcon: Icons.clear,),
         buildSizedBox(),
           const Expanded(
              child: UserView()),
        ],
