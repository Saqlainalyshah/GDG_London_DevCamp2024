...
class LoginAsStudentBody extends StatefulWidget {
  const LoginAsStudentBody({Key? key}) : super(key: key);
...
class _LoginAsStudentBodyState extends State<LoginAsStudentBody> {
  ...
  ifEmpty() {
    if (emailCon.text.isEmpty && passCon.text.isEmpty) {
      ...
      passError = "Required";
      failtriger?.fire();
    } else if (emailCon.text.isEmpty && passCon.text.isNotEmpty) {
      emailError = "Required";
      passError = " ";
      failtriger?.fire();
    } else if (emailCon.text.isNotEmpty && passCon.text.isEmpty) {
      emailError = " ";
      passError = "Required";
      failtriger?.fire();
    } else {
  ...
  ifWrong() {
    if (emailCon.text.isNotEmpty && passCon.text.isNotEmpty) {
      ...
      } else if (emailCon.text == "saqlainaly@gmail.com" &&
          passCon.text != "12345") {
        emailError = "";
        passError = "Password is incorrect";
        failtriger?.fire();
...
SizedBox buildSizedBox20() => const SizedBox(
      height: 20,
    );
